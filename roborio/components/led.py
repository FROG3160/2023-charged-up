...
REDALLIANCE = ColorFlowAnimation(64, 0, 0, 0, 0.05, NUM_STRIP_LEDS, FORWARD, NUM_CANDLE_LEDS)
BLUEALLIANCE = ColorFlowAnimation(0, 0, 64, 0, 0.05, NUM_STRIP_LEDS, FORWARD, NUM_CANDLE_LEDS)
